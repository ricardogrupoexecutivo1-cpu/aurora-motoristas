...
export default function ClienteHistoricoSupabasePage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#020617", color: "white", padding: 24 }}>
      <section style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: 34, marginTop: 8 }}>Histórico do Cliente</h1>
        <p style={{ color: "#cbd5e1", marginTop: 8 }}>
          Serviços pagos e arquivados no histórico do cliente.
        </p>
