...
function buildClientTracking(item: TransferItem) {
  ...
  const atraso =
    item.acrescimoTransitoMin > 0
      ? ` com acréscimo estimado de ${item.acrescimoTransitoMin} min por trÃ¢nsito`
      : "";
                    ...
                    return (
                      <article key={`${item.origemBase}-${item.id}`} style={styles.transferItemCard}>
                        ...
                        <div style={styles.transferGrid}>
                          ...
                          <div style={styles.dataItem}>
                            <span style={styles.dataLabel}>Acréscimo trÃ¢nsito</span>
                            <input
          ...
          <aside style={styles.rightColumn}>
            ...
            <div style={styles.darkCard}>
              ...
              <p style={styles.sidebarTextDark}>
                O RobÃ´ Aurora poderá alertar atrasos, horários conflitantes,
